...
const HeroSection = () => {
  return (
    <section className="bg-red-50 p-8 h-[90dvh] max-h-[512px] md:h-[85dvh] flex flex-col lg:flex-row justify-end lg:justify-start xl:justify-center lg:items-center bg-cover bg-center bg-[url('/img/bg/hero_mobile_bg.png')] md:bg-[url('/img/bg/hero_tablet_bg.png')] lg:bg-[url('/img/bg/hero_lg_bg.png')]">
