...
const AgentsSection = () => {
  return (
    <section className="bg-[var(--off-white)] p-8 h-[70dvh] md:h-[40dvh] lg:h-[30dvh] flex justify-center items-center gap-2 text-center">
      <div className="bg-[var(--bright-red)] h-[150px] min-w-[3px]"></div>
      <div className="w-fit h-fit p-5 flex flex-col md:flex-row items-center gap-8 lg:gap-2 border-[1rem] border-[var(--bright-red)]">
